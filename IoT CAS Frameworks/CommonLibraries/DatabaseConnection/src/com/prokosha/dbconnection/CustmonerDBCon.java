    ...
    Connection getCustmonerDBCon(String customerID) {
        try {
            ...
            if (!cutomerFileName.contains(this.customerID)) {
                 	System.out.println("Error: FileName: [" + cutomerFileName + "] and customerID: [" + customerID + "] miss-matched.");
            ...
            ConnectionCreator concreator = new ConnectionCreator(databaseDriver, databaseURL, databaseUser, databasePassword);
             con = concreator.getConnection();
            concreator = null;
            } catch (Exception e) {
			System.out.println("getting connection from file: " + cutomerFileName);
			e.printStackTrace();
            ...
            e.printStackTrace();
            log.error("Error in getCustmonerDBCon");
        }
        return null;
    }

    private void readINIFile() {
        String absolutePath = System.getProperty("user.home") + System.getProperty("file.separator") + cutomerFileName.trim();
        ...
        try {
            ...
            if(!file.exists()){
            	...
            	System.out.println("Reading File For Database Connection: "+absolutePath);
            }
