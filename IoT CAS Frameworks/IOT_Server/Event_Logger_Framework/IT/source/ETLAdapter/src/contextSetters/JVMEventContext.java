...
public class JVMEventContext {
    ...
    public JVMEventContext(Properties pro) throws IOException {
        fields = pro.getProperty("JVMEventContext");
    ...
    public ReportData setContexts(ReportData rData) {
        System.out.println(".................Setting the JVM Context ..................");
