        ...
        try {
            ...
            if (flag1 || flag2) {
                ...
                if (resourceId != null) {
                    ...
                    ResultSet rs = stmt.executeQuery("Select service,subservice,hostgroup,resourceType,resourceSubType,resourceId from hostinfo where host='" + resourceId + "' and resourcetype='"+resourceType+"'");
                    while (rs.next()) {
