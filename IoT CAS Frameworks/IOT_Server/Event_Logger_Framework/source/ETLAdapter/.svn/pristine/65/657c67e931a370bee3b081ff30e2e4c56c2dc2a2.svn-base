...
public class NetEventContext {
    ...
    public NetEventContext(Properties pro) throws IOException{
        fields = pro.getProperty("NetEventContext");
    ...
    public ReportData setContexts(ReportData rData){
        ...
        System.out.println(".................Setting the NetEvent Context ..................");
