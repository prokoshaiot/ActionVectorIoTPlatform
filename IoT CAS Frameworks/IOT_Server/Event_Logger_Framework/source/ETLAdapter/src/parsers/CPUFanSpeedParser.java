 ...
 * @author satya
 */
public class CPUFanSpeedParser {
    ...
    public CPUFanSpeedParser(String CEPEvent, String metrics, Properties properties, String eventID) {
        ...
        try {
            ...
            if (flag1 || flag2) {
                ...
                if (resourceId != null) {
                    ...
                    ResultSet rs = stmt.executeQuery("Select service,subservice,hostgroup,resourceType,resourceSubType,resourceId from "
                            + "hostinfo where host='" + resourceId + "' and resourcetype='"+resourceType+"'  and customerid='" 
                    ...
                    flag2 = service == null || subService == null  || service.equalsIgnoreCase("null") || subService.equalsIgnoreCase("null") || hostGroup.equalsIgnoreCase("null");
                    if (flag1 || flag2) {
