...
public class ConnectionMap {
    ...
    private HashMap<String, Statement> gConectionStaementMap = new HashMap<String, Statement>();
    ...
    public Statement getConntionStatementWithID(String customerID) {
        ...
        try {
            // System.out.println("gConectionMap = " + gConectionMap);
            // System.out.println("gConectionMap.containsKey("+customerID+") = " + gConectionMap.containsKey(customerID));
            if (gConectionStaementMap.containsKey(customerID)) {
                conStat = gConectionStaementMap.get(customerID);
                // System.out.println("Is Connection Closed==="+con.isClosed());
                try {
                    if (conStat != null) {
            ...
            gConectionStaementMap.put(customerID, conStat);
            return conStat;
