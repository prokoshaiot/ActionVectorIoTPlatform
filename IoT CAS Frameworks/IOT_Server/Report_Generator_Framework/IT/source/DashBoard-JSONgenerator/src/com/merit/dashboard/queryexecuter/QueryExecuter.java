...
//            Connection dataBaseConnectionMetric = ConnectionDAO.getReaderConnection(customer);
...
//            Connection dataBaseConnectionTicket = ConnectionDAO.getReaderConnection(customer + "");
...
//            stat = uniqueconnection.createStatement();
            ...
            String szQuery = "select host,resourcetype,ServiceName,resourceID,case when sum(criticalcheck)>0 "
                    ...
                    resourceType + "' group by attributes4,attributes12,attributes6,attributes10,criticalcheck)"
                    + " as alert group by host,resourcetype,ServiceName,resourceID";
            /**
             * ***************************************************************************************************
             * This Query will give Modified result from all necessary tables
             * like gatasktypeassignee, gatask table .. here concatenating the
...
//            stat = uniqueconnection.createStatement();
    ...
    public String getWatchDogAlertJson(String customer) {
        String watchDogQuery = "select host,metrictype,"
                ...
                + "resourcetype from servicemetrics where metrictype in ("+DBUtilHelper.getMetrics_mapping_properties().getProperty("WatchDogMetricList")+") group by metrictype,resourcetype,host";
        System.out.println("WatchDog Query:===="+watchDogQuery);
        String watchdogJson = "[";
        try {
            Connection uniqueconnection = ConnectionDAO.getReaderConnection(customer);
...
//            Statement stat2 = uniqueconnection.createStatement();
            ...
            while (rs4.next()) {
                ...
                if (resourceType.equals("Desktop")) {
                    ...
                    propertyMetricName6 = propertyMetricName5 + ",\"" + DBUtilHelper.getMetrics_mapping_properties().getProperty(rs4.getString("metrictype")) + "\"";
            ...
            if(!propertyMetricName6.equals("")){
                propertyMetricName6=propertyMetricName5.substring(1);
            }
            ...
            MetricResourceTypeMappingJson  =  "[{"
                                            ...
                                            + "},{"
                                                ...
                                                + "\"ResourceNames\":[" + propertyMetricName6 + "]"
                                            + "}]";
            ConnectionDAO.closeStatement();
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public String generateServicePerformanceJson(String szResourceType, String metricType, String configuredMetricType, String jsonGenerator, String startDate,
        ...
        try {
            ...
            Class[] inputArr = new Class[]{String.class, String.class, String.class, Long.TYPE, 
                Long.TYPE, String.class, String.class};
            Method generatorMthd = generatorCls.getDeclaredMethod("generateJSON", inputArr);
            perfJSON = (String) generatorMthd.invoke(generatorObj, szResourceType, metricType, configuredMetricType, 
