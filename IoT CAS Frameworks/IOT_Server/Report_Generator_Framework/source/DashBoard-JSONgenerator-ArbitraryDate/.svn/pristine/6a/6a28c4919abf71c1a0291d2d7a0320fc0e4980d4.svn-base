...
/**
 * This class is used to get Parameters and generate JSON string for making Summary grid
 * 	(This summary view is generated by clicking on chart series)
 * @author satya
 */
@SuppressWarnings("serial")
public class ReportsController1 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
		...
		try {
            ...
            sz_response_JSON= helper.getMetricTypeWithTimestamp(sz_customerID, sz_metricType, sz_hostName, sz_resourceType,sz_combobox_selected,sz_tab_selected,sz_interval);
