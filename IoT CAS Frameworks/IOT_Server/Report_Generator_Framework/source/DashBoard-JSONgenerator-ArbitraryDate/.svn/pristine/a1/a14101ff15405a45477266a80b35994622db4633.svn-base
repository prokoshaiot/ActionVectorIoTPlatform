...
/**
 *
 * @author Manoj Kumar Sahu Creation Date: Apr 12, 2013 Creation Time: 6:44:21
 * PM
 */
...
//            }
    ...
    public static JSONArray changeReultSetToJSONArray(ResultSet rs, String[] columnLabels) throws SQLException {
        JSONArray arr = new JSONArray();
