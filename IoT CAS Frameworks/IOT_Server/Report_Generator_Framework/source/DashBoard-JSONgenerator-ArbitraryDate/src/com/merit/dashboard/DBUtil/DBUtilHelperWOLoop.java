 ...
 *
 */
public class DBUtilHelperWOLoop {
    ...
    public static String AllMetricUOMURL = null;
    ...
    public DBUtilHelperWOLoop() {
        ...
        if (!flag) {
            ...
            try {
                ...
                AllMetricUOMURL = metrics_mapping_properties.getProperty("GetAllMetricUOMURL");
