...
public class ServiceThreadListener extends Thread {
    ...
    public static String argRefTime = null;
    ...
    public static String gPeriod = null;
    ...
    public static void main(String[] args) {
        try {
            ...
            for (String arg : args) {
                ...
                if (arg.contains("--referenceTime=") || arg.contains("--referencetime=") || arg.contains("--ReferenceTime=")) {
                    arg = arg.split("=")[1];
                    System.out.println("ReferenceTime=" + arg);
                    log.info("ReferenceTime=" + arg);
                    argRefTime = arg;
                } else {
                    System.out.println("No ReferenceTime");
                    log.info("No ReferenceTime");
                }
            }
            PropertyConfigurator.configure("resource/logger.properties");
            new DBUtilHelper();
            DateGenerator.initializePeriod(gPeriod, argRefTime);
            ...
            types = DBUtilHelper.getMetrics_mapping_properties().getProperty("ResourceName").split(",");
        ...
        try {
            ...
            for (int i = 0; i < len1; i++) {
                ...
                for (int j = 0; j < len2; j++) {
                    ...
                    genType = tjsonObj.getString("generationType");
                    if (!(genType.equalsIgnoreCase("derived"))) {
                        periods = tjsonObj.getString("generationPeriod");
                        if (periods.equalsIgnoreCase("all") || periods.contains(gPeriod)) {
