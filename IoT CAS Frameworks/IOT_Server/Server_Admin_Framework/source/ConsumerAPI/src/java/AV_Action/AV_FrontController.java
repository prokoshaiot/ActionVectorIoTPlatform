 ...
 * @author niteshc
 */
public class AV_FrontController extends HttpServlet {

    static Logger log = Logger.getLogger(AV_FrontController.class);
    ...
    public void init(ServletConfig config) throws ServletException {
        System.out.println("In init() of EventReceiver");
