...
public class InitDBDomain
{
    ...
    public String getSzDataSourceName()
    {
        return szDataSourceName;
    }

    public String getSzDatabaseDriver()
    {
        return szDatabaseDriver;
    }

    public String getSzDatabaseName()
    {
        return szDatabaseName;
    }

    public String getSzDatabasePassword()
    {
        return szDatabasePassword;
    }

    public String getSzDatabaseUser()
    {
    ...
    public boolean initialize(String szServerName)
    {
