...
public class ReportsController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
		...
		try {
            ...
            sz_response_JSON= helper.getMetricTypeWithTimestamp(sz_customerID, sz_metricType, sz_hostName, sz_resourceType,sz_combobox_selected,sz_tab_selected,sz_interval,resourceid);
